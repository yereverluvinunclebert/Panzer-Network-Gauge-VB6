# Panzer-Network-Gauge-VB6
  ...
  A FOSS Network Gauge VB6 WoW64 Widget for Windows Vista, 7, 8 and 10/11+. There will also be a version for Reactos and XP, watch this space for the link. Also tested and running well on Linux and Mac os/X using Wine.
 
 My current VB6/RC6 PSD program being worked upon now, about 97% complete, now creating the Help HTML, awaiting testing on Windows XP and Win7 32bit and some multi-monitor checking, completion of the CHM help file and the creation of the setup.exe. This Panzer widget is based upon the Yahoo/Konfabulator widget of the same visual design and very similar operation.
 ...
 * HELP.CHM - the program documentation is built using the NVU HTML editor and 
 ...
 HELP folder. Users should ensure they obtain and use it in accordance with its original licensing terms.
