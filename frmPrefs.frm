...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzNetworkGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
...
'    End If
    ...
    If gblStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzNetworkGaugeWidget", """" & App.path & "\" & "Panzer Network Gauge.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzNetworkGaugeWidget", vbNullString)
    End If

    ' save the values from the general tab
    If fFExists(gblSettingsFile) Then
        sPutINISetting "Software\PzNetworkGauge", "enableTooltips", gblEnableTooltips, gblSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "enableBalloonTooltips", gblEnableBalloonTooltips, gblSettingsFile
        ...
        sPutINISetting "Software\PzNetworkGauge", "gaugeFunctions", gblGaugeFunctions, gblSettingsFile
        ...
        'sPutINISetting "Software\PzNetworkGauge", "clockFaceSwitchPref", gblClockFaceSwitchPref, gblSettingsFile
        ...
        sPutINISetting "Software\PzNetworkGauge", "clockFont", gblClockFont, gblSettingsFile
        ...
        sPutINISetting "Software\PzNetworkGauge", "defaultEditor", gblDefaultEditor, gblSettingsFile
        
        sPutINISetting "Software\PzNetworkGauge", "clockHighDpiXPos", gblClockHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "clockHighDpiYPos", gblClockHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzNetworkGauge", "clockLowDpiXPos", gblClockLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "clockLowDpiYPos", gblClockLowDpiYPos, gblSettingsFile
...
'    cmbMainDaylightSaving.ListIndex = Val(gblMainDaylightSaving)
    ...
    txtDefaultEditor.Text = gblDefaultEditor
    lblGitHub.Caption = "You can find the code for the Panzer Network Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/ Panzer-Network-Gauge-VB6"
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Panzer-Network-Gauge-VB6", vbNullString, App.path, 1)
    End If
...
'        sliAnimationInterval.ToolTipText = "Adjust to make the animation smooth or choppy. Any adjustment in the interval takes place instantly. Lower values are smoother but the smoother it runs the more Network it uses."
...
'        cmbMainDaylightSaving.ToolTipText = "Select and activate Daylight Savings Time for your area."
        ...
        cmbTickSwitchPref.ToolTipText = "The movement of the hand can be set to smooth or regular flicks, the smooth movement uses slightly more Network."
