...
Private Sub chkDpiAwareness_Click()
    ...
    If prefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzNetworkGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzNetworkGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
...
'    End If
    ...
    If fFExists(PzGSettingsFile) Then
        sPutINISetting "Software\PzNetworkGauge", "enableTooltips", PzGEnableTooltips, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "enableBalloonTooltips", PzGEnableBalloonTooltips, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "showTaskbar", PzGShowTaskbar, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
        
        
        sPutINISetting "Software\PzNetworkGauge", "gaugeSize", PzGGaugeSize, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "scrollWheelDirection", PzGScrollWheelDirection, PzGSettingsFile
                
        sPutINISetting "Software\PzNetworkGauge", "gaugeFunctions", PzGGaugeFunctions, PzGSettingsFile
        ...
        sPutINISetting "Software\PzNetworkGauge", "aspectHidden", PzGAspectHidden, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "widgetPosition", PzGWidgetPosition, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "widgetLandscape", PzGWidgetLandscape, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "widgetPortrait", PzGWidgetPortrait, PzGSettingsFile

        sPutINISetting "Software\PzNetworkGauge", "prefsFont", PzGPrefsFont, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "clockFont", PzGClockFont, PzGSettingsFile
        
        sPutINISetting "Software\PzNetworkGauge", "prefsFontSizeHighDPI", PzGPrefsFontSizeHighDPI, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "prefsFontSizeLowDPI", PzGPrefsFontSizeLowDPI, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "prefsFontItalics", PzGPrefsFontItalics, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "prefsFontColour", PzGPrefsFontColour, PzGSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzNetworkGauge", "windowLevel", PzGWindowLevel, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "preventDragging", PzGPreventDragging, PzGSettingsFile
        
        sPutINISetting "Software\PzNetworkGauge", "opacity", PzGOpacity, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "hidingTime", PzGHidingTime, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "ignoreMouse", PzGIgnoreMouse, PzGSettingsFile
        
        
        sPutINISetting "Software\PzNetworkGauge", "startup", PzGStartup, PzGSettingsFile

        sPutINISetting "Software\PzNetworkGauge", "enableSounds", PzGEnableSounds, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "lastSelectedTab", PzGLastSelectedTab, PzGSettingsFile
        
        sPutINISetting "Software\PzNetworkGauge", "debug", PzGDebug, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "dblClickCommand", PzGDblClickCommand, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "openFile", PzGOpenFile, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "defaultEditor", PzGDefaultEditor, PzGSettingsFile
        
        sPutINISetting "Software\PzNetworkGauge", "clockHighDpiXPos", PzGClockHighDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "clockHighDpiYPos", PzGClockHighDpiYPos, PzGSettingsFile
        ...
        sPutINISetting "Software\PzNetworkGauge", "maxSpeed", PzGMaxSpeed, PzGSettingsFile
        sPutINISetting "Software\PzNetworkGauge", "minSpeed", PzGMinSpeed, PzGSettingsFile
...
'    panzerPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\PzNetworkGauge", "skinTheme", PzGSkinTheme, PzGSettingsFile
